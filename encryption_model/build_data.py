...
tf.flags.DEFINE_string('Z_input_dir', 'datasets/poison/100a',
                       'Z input directory, default: data/apple2orange/trainB')
tf.flags.DEFINE_string('Z_output_file', 'datasets/poison.tfrecords',
                       'Z output tfrecords file, default: data/tfrecords/orange.tfrecords')
...
def main(unused_argv):
    ...
    print("Convert backdoor data to tfrecords...")
    data_writer(FLAGS.Z_input_dir, FLAGS.Z_output_file)
