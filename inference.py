...
# tf.flags.DEFINE_string('model', 'pretrained/men_to_women.pb', 'model path (.pb)')
...
tf.flags.DEFINE_string('model', 'pretrained/mingwen_to_miwen.pb', 'model path (.pb)')
tf.flags.DEFINE_string('input', 'input/MCUCXR_0005_0.png', 'input image path (.png)')
tf.flags.DEFINE_string('output', 'output/MCUCXR_0005_0.png', 'output image path (.png)')
